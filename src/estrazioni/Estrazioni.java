/*
 * Estrazionicon controllo versione.
 */
package estrazioni;
...
public class Estrazioni {
    ...
    public static void main(String[] args) {
        ...
        v.bubbleSort(pippicalzelunghe);
        System.out.println("Ecco l'array in ordine:");
        for(int i = 0; i < pippicalzelunghe.length; i ++){
            System.out.println(pippicalzelunghe[i]);
        }
    }
}
